...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-03-2026 a las 22:26:08
...
(1, 'Todos', '2026-03-01 21:24:36', NULL, '1');
...
(1, 'Coordinador', '2026-03-01 21:24:36', NULL, '1'),
(2, 'Docente', '2026-03-01 21:24:36', NULL, '1');
...
(1, 1, 1, '2026-03-01 21:24:36', NULL, '1'),
(2, 1, 2, '2026-03-01 21:24:36', NULL, '1');
...
(1, 'Nasser J.', 'Daboin R.', 'nasserdaboin@gmail.com', '31215545', NULL, '$2y$12$rS9/5YQoeAG9lF597ZPOq.wPix4C/vWLo7LWekPhEWYt2fwlZkXeO', NULL, '2026-03-01 21:24:36', '1'),
(2, 'Enmanuel Salas', 'Salas', 'enmanuelsalas0911@gmail.com', '31114131', NULL, '$2y$12$AX2LT7s.7FH2TOv.5KUVrOptXZbn9I9jYkye9WFiYEabcXwCn.vJG', NULL, '2026-03-01 21:24:36', '1');
...
(1, 1, 1, '2026-03-01 21:24:36', NULL, '1'),
(2, 2, 1, '2026-03-01 21:24:36', NULL, '1');
...
ALTER TABLE `rol_permiso`
  ...
  ADD KEY `fk_rperm_rol` (`id_rol`),
  ADD KEY `fk_rperm_perm` (`id_permiso`);
...
--
ALTER TABLE `rol_permiso`
  ADD CONSTRAINT `fk_rperm_perm` FOREIGN KEY (`id_permiso`) REFERENCES `permiso` (`id_permiso`),
  ADD CONSTRAINT `fk_rperm_rol` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`);
...
--
ALTER TABLE `usuario_rol`
  ADD CONSTRAINT `fk_urol_rol` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`),
