...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-02-2026 a las 16:44:05
...
INSERT INTO `bitacora` (`id_bitacora`, `id_users`, `tabla_afectada_bitacora`, `id_registro_afectado_bitacora`, `accion_bitacora`, `valores_anteriores_bitacora`, `valores_nuevos_bitacora`, `ip_origen_bitacora`, `fecha_creacion`, `estatus`) VALUES
(1, 1, 'users', 1, 'LOGIN', NULL, NULL, '127.0.0.1', '2026-02-28 18:50:12', '1'),
(2, 1, 'tema_unidad', 1, 'CREAR', NULL, '{\"id_unidad_curricular\":\"809\",\"titulo_tema\":\"prueba\",\"unidad_tema\":\"2\",\"fecha_creacion\":\"2026-02-28T14:51:01.542543Z\",\"fecha_actualizacion\":null,\"estatus\":\"1\",\"id_tema_unidad\":1}', '127.0.0.1', '2026-02-28 18:51:01', '1'),
(3, 1, 'tema_unidad', 1, 'MOSTRAR', '{\"id_tema_unidad\":1,\"id_unidad_curricular\":\"809\",\"titulo_tema\":\"prueba\",\"unidad_tema\":\"2\",\"fecha_creacion\":\"2026-02-28 14:51:01\",\"fecha_actualizacion\":null,\"estatus\":\"1\"}', NULL, '127.0.0.1', '2026-02-28 18:51:12', '1'),
(4, 1, 'tema_unidad', 1, 'MOSTRAR', '{\"id_tema_unidad\":1,\"id_unidad_curricular\":\"809\",\"titulo_tema\":\"prueba\",\"unidad_tema\":\"2\",\"fecha_creacion\":\"2026-02-28 14:51:01\",\"fecha_actualizacion\":null,\"estatus\":\"1\"}', NULL, '127.0.0.1', '2026-02-28 18:51:22', '1'),
(5, 1, 'evento', 1, 'CREAR', NULL, '{\"id_calendario\":null,\"dia_inicio_evento\":\"2026-02-28\",\"dia_fin_evento\":\"2026-02-28\",\"semana_evento\":\"1\",\"descripcion_evento\":\"dsd\",\"tipo_evento\":\"1\",\"fecha_creacion\":\"2026-02-28T15:06:35.445180Z\",\"estatus\":\"1\",\"id_evento\":1}', '127.0.0.1', '2026-02-28 19:06:35', '1'),
(6, 1, 'tema_unidad', 2, 'CREAR', NULL, '{\"id_unidad_curricular\":\"301\",\"titulo_tema\":\"asjdsd \",\"unidad_tema\":\"1\",\"fecha_creacion\":\"2026-02-28T15:06:56.414066Z\",\"fecha_actualizacion\":null,\"estatus\":\"1\",\"id_tema_unidad\":2}', '127.0.0.1', '2026-02-28 19:06:56', '1'),
(7, 1, 'tema_unidad', 2, 'MOSTRAR', '{\"id_tema_unidad\":2,\"id_unidad_curricular\":\"301\",\"titulo_tema\":\"asjdsd \",\"unidad_tema\":\"1\",\"fecha_creacion\":\"2026-02-28 15:06:56\",\"fecha_actualizacion\":null,\"estatus\":\"1\"}', NULL, '127.0.0.1', '2026-02-28 19:11:05', '1');
...
(1, NULL, '2026-02-28', '2026-02-28', 1, 'dsd', '1', '2026-02-28 19:06:35', '1');
...
(1, 'ooooo', 1, '2026-02-28 18:51:01', NULL, '1'),
(2, 'ppppp', 2, '2026-02-28 19:06:56', NULL, '1');
...
(1, 1, 1, '2026-02-28 14:48:47', '2026-02-28 14:48:47', '1'),
(2, 1, 2, '2026-02-28 14:48:47', '2026-02-28 14:48:47', '1');
...
('rDAFsxPJGdbgEynOz2r2zDOD05FOQ23IkMoeT3lb', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/145.0.0.0 Safari/537.36', '', 1772291543);
...
(1, '809', 'prueba', '2', '2026-02-28 18:51:01', NULL, '1'),
(2, '301', 'asjdsd ', '1', '2026-02-28 19:06:56', NULL, '1');
...
(1, 1, 1, '2026-02-28 14:48:47', '2025-06-27 10:08:59', '1'),
(2, 2, 1, '2026-02-28 14:48:47', '0000-00-00 00:00:00', '1');
...
ALTER TABLE `unidad_corte`
  ...
  ADD KEY `fk_unidadcorte_tecnicaact` (`id_tecnica_actividad`);
...
--
ALTER TABLE `tema_unidad`
  MODIFY `id_tema_unidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
ALTER TABLE `unidad_corte`
  ...
  ADD CONSTRAINT `fk_unidadcorte_tecnicaact` FOREIGN KEY (`id_tecnica_actividad`) REFERENCES `tecnica_actividad` (`id_tecnica_actividad`);

--
-- Filtros para la tabla `usuario_rol`
--
ALTER TABLE `usuario_rol`
  ADD CONSTRAINT `fk_usuariorol_rol` FOREIGN KEY (`id_rol`) REFERENCES `rol` (`id_rol`),
  ADD CONSTRAINT `fk_usuariorol_users` FOREIGN KEY (`id_users`) REFERENCES `users` (`id`);
COMMIT;
