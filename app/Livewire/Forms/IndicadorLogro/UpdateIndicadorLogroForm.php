...
class UpdateIndicadorLogroForm extends Form
{
    public $id_indicador_logro;
    ...
    protected function rules()
    {
        return [
            'nombre_indicador_logro' => [
                ...
                Rule::unique('indicador_logro', 'nombre_indicador_logro')->ignore($this->id_indicador_logro, 'id_indicador_logro')
            ],
        ];
    }
    ...
    public function set_indicador($indicador)
    {
        $this->id_indicador_logro = $indicador->id_indicador_logro;
        $this->nombre_indicador_logro = $indicador->nombre_indicador_logro;
    }
