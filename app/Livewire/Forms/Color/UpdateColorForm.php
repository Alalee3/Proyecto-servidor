...
class UpdateColorForm extends Form
{
    ...
    protected function rules()
    {
        return [
            'nombre_color' => [
                ...
                Rule::unique('color', 'nombre_color')->ignore($this->id_color, 'id_color')
            ],
            'codigo_color' => [
                'required',
                'string',
                'size:7',
                'regex:/^#[a-fA-F0-9]{6}$/',
                Rule::unique('color', 'codigo_color')->ignore($this->id_color, 'id_color')
            ],
        ];
    }
    ...
    protected function messages()
    {
        return [
            ...
            'nombre_color.unique' => 'Ya existe otro color con este nombre.',
            ...
            'codigo_color.unique' => 'Ya existe otro color con este código hexadecimal.',
        ];
    }

    public function setForm($color)
    {
