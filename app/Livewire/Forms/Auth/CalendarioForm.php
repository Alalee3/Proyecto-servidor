...
class CalendarioForm extends Form
{
    ...
    {
        return [
            'dia_inicio_calendario_academico' => ['required', 'date', 'before_or_equal:dia_fin_calendario_academico'],
    ...
    protected function messages()
    {
        return [
            ...
            'dia_inicio_calendario_academico.before_or_equal' => 'La fecha de inicio no puede ser posterior a la de fin.',
            ...
            'dia_fin_calendario_academico.after_or_equal' => 'La fecha de fin no puede ser anterior a la de inicio.',
        ];
    }
