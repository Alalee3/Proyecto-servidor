...
<x-modal-base wire:model="showCreateColorModal">
    <div class="bg-white dark:bg-gray-800 shadow-sm">
        <div class="p-4 sm:p-6">
            <h3 class="font-bold text-xl text-gray-800 dark:text-gray-500 leading-tight uppercase text-center mb-6">
            ...
            <x-secondary-button type="button" class="!px-5 !py-2.5 !text-sm" wire:click="$set('showCreateColorModal', false)">
                {{ __('Cancelar') }}
            </x-secondary-button>
