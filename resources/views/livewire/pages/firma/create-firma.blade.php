        ...
        <form wire:submit.prevent="guardar" class="w-full space-y-6" novalidate>
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="w-full max-w-lg mx-auto">
                    <x-input-label for="foto_firma" :value="__('Imagen de Firma *')" />
                    <div class="mt-1"
                        x-data="{ 
                            preview: null,
                            isDragging: false,
            ...
            @if ($form->foto_firma)
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-4 bg-gray-50 dark:bg-gray-900">
                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Vista previa del resultado (PNG sin fondo):</p>
