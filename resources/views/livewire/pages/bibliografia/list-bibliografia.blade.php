        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 sm:rounded-lg">
            ...
            <div class="sogat-table-container">
                ...
                <div
                    ...
                    <x-table.search-input model="busqueda" placeholder="Buscar Bibliografía..." debounce="300ms" />
                </div>
                    ...
                    <tbody>
                        @if ($bibliografias->isNotEmpty())
                            @foreach ($bibliografias as $bibliografia)
                                <tr wire:key="{{ $bibliografia->id_bibliografia }}"
                                    ...
                                    <td class="px-4 py-4 text-right">
                                        <span class="{{ $bibliografia->estatus == 1 ? 'bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300' : 'bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300' }} 
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center justify-end space-x-3">
                                            <!-- Ver -->
                                            <a href="{{ route('bibliografia/show', $bibliografia->id_bibliografia) }}"
                                                wire:navigate
                                            ...
                                            <!-- Editar -->
                                            <a href="{{ route('bibliografia/update', $bibliografia->id_bibliografia) }}"
                                                wire:navigate
                                            ...
                                            @else
                                                <!-- Restaurar -->
                                                <button wire:click="confirmarRestaurar({{ $bibliografia->id_bibliografia }})"
                ...
                <x-table.delete-modal :show="$idInhabilitar !== null" title="Confirmar Inhabilitación"
                    message="¿Estás seguro de que deseas inhabilitar esta bibliografía?"
                ...
                <x-table.delete-modal :show="$idRestaurar !== null" title="Confirmar Restauración"
                    message="¿Estás seguro de que deseas restaurar esta bibliografía?"
