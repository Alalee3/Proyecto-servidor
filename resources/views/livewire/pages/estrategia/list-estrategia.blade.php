        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 sm:rounded-lg">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                <div
                    ...
                    <x-table.search-input model="busqueda" placeholder="Buscar estrategia..." debounce="300ms" />
                </div>
                    ...
                    <tbody>
                        @if ($estrategias->isNotEmpty())
                            @foreach ($estrategias as $estrategia)
                                <tr wire:key="{{ $estrategia->id_estrategia_pedagogica }}"
                                    ...
                                    <td class="px-4 py-4">
                                        <div class="flex items-center justify-end space-x-3">
                                            <!-- Ver -->
                                            <a href="{{ route('estrategia/show', $estrategia->id_estrategia_pedagogica) }}"
                                                wire:navigate
                                            ...
                                            <!-- Editar -->
                                            <a href="{{ route('estrategia/update', $estrategia->id_estrategia_pedagogica) }}"
                                                wire:navigate
                                            ...
                                            @if ($estrategia->estatus == 1)
                                                <!-- Inhabilitar -->
                                                <button
                                                    wire:click="confirmarInhabilitar({{ $estrategia->id_estrategia_pedagogica }})"
                                            ...
                                            @else
                                                <!-- Restaurar -->
                                                <button wire:click="confirmarRestaurar({{ $estrategia->id_estrategia_pedagogica }})"
                        ...
                        @else
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                    {{ $busqueda ? 'No se encontraron estrategias' : 'No hay estrategias registradas' }}
                                </td>
                            </tr>
                        @endif
                    </tbody>
                ...
                <x-table.delete-modal :show="$idInhabilitar !== null" title="Confirmar Inhabilitación"
                    message="¿Estás seguro de que deseas inhabilitar esta estrategia pedagógica?"
                ...
                <x-table.delete-modal :show="$idRestaurar !== null" title="Confirmar Restauración"
                    message="¿Estás seguro de que deseas restaurar esta estrategia pedagógica?"
