        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 sm:rounded-lg">
            ...
            <div class="sogat-table-container">
                <div
                    ...
                    <x-table.search-input model="busqueda" placeholder="Buscar Indicador..." debounce="300ms" />
                </div>
                ...
                <x-table.delete-modal :show="$idInhabilitar !== null" title="Confirmar Inhabilitación"
                    message="¿Estás seguro de que deseas inhabilitar este indicador?"
                ...
                <x-table.delete-modal :show="$idRestaurar !== null" title="Confirmar Restauración"
                    message="¿Estás seguro de que deseas restaurar este indicador?" cancel-method="$set('idRestaurar', null)"
            ...
            <div
                ...
                <div>@if ($indicadores->isNotEmpty()) {{ $indicadores->links() }} @endif</div>
            </div>
        </div>
    </div>
</div>
