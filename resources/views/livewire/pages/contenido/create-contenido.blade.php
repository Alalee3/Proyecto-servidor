                ...
                <form wire:submit.prevent="save" class="w-full space-y-6" novalidate>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="w-full">
                            ...
                            <x-select id="unidad" wire:model.live="form.id_unidad_curricular" :options="$unidades"
                                valueField="id" textField="nombre" placeholder="Selecciona una unidad"
                                class="w-full mt-1" errorField="form.id_unidad_curricular" required />
                        </div>

                        <!-- Corte -->
                        <div class="w-full">
                            <x-input-label for="corte" :value="__('Corte')" />
                            <select id="corte" wire:model.live="form.corte_contenido"
