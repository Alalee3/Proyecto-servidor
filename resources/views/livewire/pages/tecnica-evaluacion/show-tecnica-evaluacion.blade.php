<div>
    ...
    <x-slot name="header">
        <h2
            ...
            {{ $evaluacion && $evaluacion->estatus != 1 ? __('Detalles de la Técnica Inactiva') : __('Detalles de la Técnica de Evaluación') }}
        </h2>
    </x-slot>
                ...
                @if ($evaluacion)
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                                <div>
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300 text-2xl font-semibold break-words overflow-hidden">
                                        {{ $evaluacion->nombre_tecnica_evaluacion }}
                                    </p>
                                </div>
                    ...
                    : 'px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:bg-red-600 dark:text-red-100' }}">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700 dark:text-gray-300 text-2xl font-semibold">
                                        {{ \Carbon\Carbon::parse($evaluacion->fecha_creacion)->format('d/m/Y H:i') }}
                                    </p>
                                </div>
                            </div>
                @else
