        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="sogat-card planificacion-module p-10">
                <div class="text-center mb-10">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Diligencie cada paso en los siguientes apartados.</p>
                </div>
                ...
                <style>
                    ...
                    .vanilla-calendar-header__btn, .vanilla-calendar-arrow, .vc-arrow, .vc-header__arrow, .vanilla-calendar-header__btn_prev, .vanilla-calendar-header__btn_next { display: none !important; }
                ...
                <div class="space-y-6" x-data="{ 
                    ...
                    <div class="border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm transition-all duration-300">
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" @click="openSection = openSection === 'fechas' ? '' : 'fechas'">
                            ...
                            <span class="material-icons transition-transform duration-200" :class="openSection === 'fechas' ? 'rotate-180' : ''">expand_more</span>
                        </div>
                        <div x-show="openSection === 'fechas'" x-collapse class="p-4 space-y-6">
                            ...
                            <div class="flex justify-end pt-4 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 mt-4 -mx-4 -mb-4 p-4">
                                <button type="button" @click="openSection = 'eventos'"
                                    ...
                                    SIGUIENTE: ASIGNAR EVENTOS <span class="material-icons text-sm">arrow_forward</span>
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- Acordeón 2: Eventos --}}
                    <div class="border-2 border-gray-200 dark:border-gray-700 rounded-xl shadow-sm transition-all duration-300">
                        <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors" @click="openSection = openSection === 'eventos' ? '' : 'eventos'">
                            <h4 class="text-sm font-bold text-gray-700 dark:text-gray-300 uppercase tracking-wider flex items-center gap-2">
                                <span class="material-icons text-red-500">event</span>
                                Asignación de Eventos
                            </h4>
                            <span class="material-icons transition-transform duration-200" :class="openSection === 'eventos' ? 'rotate-180' : ''">expand_more</span>
                        </div>
                        <div x-show="openSection === 'eventos'" x-collapse class="p-4 space-y-6">
                            ...
                            <div x-show="!inicio || !fin" class="text-center p-8">
                                ...
                                <p class="text-sm font-bold text-gray-500 uppercase">Debe configurar primero el inicio y fin del período en la sección anterior.</p>
                            </div>
                                ...
                                <div x-data="{
                                    ...
                                    inicializarPicker(year) {
                                        ...
                                        this.picker = new VanillaCalendar(this.$refs.calendar, {
                                            ...
                                            settings: {
                                                lang: 'es',
                                                range: { min: inicio, max: fin, disablePast: false },
                                    ...
                                    <template x-if="calStartYear && calEndYear && calStartYear >= calEndYear">
                                        <div class="text-center mb-8 mt-2">
                                            <span x-text="currentYear" class="text-7xl font-black text-gray-800 dark:text-gray-100 drop-shadow-sm" style="font-family: 'Verdana', sans-serif; letter-spacing: -0.05em;"></span>
                                        </div>
                                    </template>
                    ...
                    <div class="flex justify-end pt-4 gap-4">
                        <a href="{{ route('calendario.list') }}" wire:navigate>
                            <button type="button" class="group inline-flex items-center gap-3 px-8 py-4 bg-gray-500 text-white rounded-2xl font-black text-sm uppercase tracking-widest hover:bg-gray-600 focus:outline-none transition-all duration-300 shadow-xl hover:shadow-gray-500/20 active:scale-95">
                                CANCELAR
                            </button>
                        </a>
                        <button type="button" wire:click="save"
                            ...
                            <span class="material-icons text-lg transition-transform group-hover:rotate-12" wire:loading.remove wire:target="save">save</span>
                            <span wire:loading.remove wire:target="save">GUARDAR CALENDARIO COMPLETO</span>
