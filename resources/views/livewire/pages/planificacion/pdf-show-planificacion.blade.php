...
<head>
    ...
    <style>
        body { font-family: sans-serif; font-size: 9pt; line-height: 1.4; color: #333; }
        .page-break { page-break-after: always; }
        .header { text-align: center; margin-bottom: 20px; border-bottom: 2px solid #444; padding-bottom: 10px; }
        .info-section { margin-bottom: 15px; }
        .info-grid { width: 100%; border-collapse: collapse; }
        .info-grid td { padding: 4px; border: none; }
        .label { font-weight: bold; width: 150px; }
        .section-title { background: #f0f0f0; padding: 5px 10px; font-weight: bold; border-left: 4px solid #333; margin: 15px 0 10px; text-transform: uppercase; }
        ...
        .corte-header { font-size: 12pt; background: #333; color: #fff; padding: 8px; margin-top: 20px; text-align: center; }
        .footer { text-align: center; font-size: 8pt; margin-top: 30px; border-top: 1px solid #ccc; padding-top: 10px; }
    </style>
</head>
<body>
    <div class="header">
    ...
    @foreach($planificacion->cortes as $corte)
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><strong>{{ $cont['titulo_contenido'] }}</strong><br><small>{{ $cont['descripcion_contenido'] }}</small></td>
                    <td>
