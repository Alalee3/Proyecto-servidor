                        ...
                        @foreach ($misRoles as $miRol)
                            <div wire:click="cambiarRol({{ $miRol->usu_cod_rol }})" 
                                 ...
                                 {{ $rolActivo == $miRol->usu_cod_rol 
                                    ? 'bg-blue-50 dark:bg-blue-900/20 border-[#265dcf] ring-2 ring-blue-200 dark:ring-blue-800' 
                                    : 'bg-gray-50 dark:bg-gray-900/50 border-gray-200 dark:border-gray-700 hover:border-[#265dcf] hover:shadow-md' }}">
                                ...
                                <div class="flex items-center justify-between">
                                    ...
                                    @if($rolActivo == $miRol->usu_cod_rol)
                                        <span class="material-icons text-[#265dcf] dark:text-blue-400">check_circle</span>
                                    @endif
                                </div>
                            </div>
                        @endforeach
